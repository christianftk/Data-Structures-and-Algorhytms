...
class Vector : virtual public LinearContainer<Data>, virtual public SearchableContainer<Data>{ // Should extend LinearContainer<Data> and SearchableContainer<Data>
...
public:
  ...
  Vector(const unsigned long); // A vector with an initial given dimension.
  // Copy constructor
  Vector(const Vector&);
  ...
  void Resize(const unsigned long); // Resize the vector
