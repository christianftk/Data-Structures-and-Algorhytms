...
template <typename Data>
lasd::BinaryTreeVec<Data>::BinaryTreeVec(BinaryTreeVec&& yTree){
    size = std::move(yTree.Size());
    Tree = std::move(yTree.Tree);
    NodesAtLevel = std::move(yTree.NodesAtLevel);
}
...
lasd::BinaryTreeVec<Data>& lasd::BinaryTreeVec<Data>::operator=(const BinaryTreeVec& yTree){
    ...
    std::swap(NodesAtLevel, tmp.NodesAtLevel);
    delete tmp;
    return *this;
}
template <typename Data>
lasd::BinaryTreeVec<Data>& lasd::BinaryTreeVec<Data>::operator=(BinaryTreeVec&& yTree){
    size = std::move(yTree.size);
    Tree = std::move(yTree.Tree);
    NodesAtLevel = std::move(yTree.NodesAtLevel);
    return *this;
