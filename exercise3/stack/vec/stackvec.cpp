...
template <typename Data>
lasd::StackVec<Data>::StackVec(StackVec&& yStack){
...
lasd::StackVec<Data>& lasd::StackVec<Data>::operator=(const StackVec& yStack){
    StackVec<Data> tmpStack(yStack);
    std::swap(*tmpStack, *this);
    delete tmpStack;
    return *this;
}
template <typename Data>
lasd::StackVec<Data>& lasd::StackVec<Data>::operator=(StackVec&& yStack){
    *this = std::move(yStack);
    return *this;
}
