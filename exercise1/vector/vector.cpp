...
template <typename Data>
lasd::Vector<Data>::Vector(const lasd::Vector<Data>& v){
...
//Move Constructor
template <typename Data>
lasd::Vector<Data>::Vector(lasd::Vector<Data>&& v) noexcept{
...
//Operators
template <typename Data>
lasd::Vector<Data>& lasd::Vector<Data>::operator=(const lasd::Vector<Data>& v1){
    Vector<Data> v2(v1);
    std::swap(*v2, *this);
    delete v2;
    return *this;
...
template <typename Data>
lasd::Vector<Data>& lasd::Vector<Data>::operator=(lasd::Vector<Data>&& v1){
...
template <typename Data>
bool lasd::Vector<Data>::operator==(const lasd::Vector<Data>& v1) const noexcept{
    unsigned long i = 0;
    bool equals = true;
    if(size == v1.size){
        while(equals && i < size){
...
//Specific member functions of Vectors
template <typename Data>
