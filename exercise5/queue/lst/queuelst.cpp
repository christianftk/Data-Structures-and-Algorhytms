...
template <typename Data>
lasd::QueueLst<Data>::QueueLst(QueueLst&& yQueue) noexcept{
...
lasd::QueueLst<Data>& lasd::QueueLst<Data>::operator=(const QueueLst& yQueue){
    QueueLst<Data>* tmp = new QueueLst<Data>(yQueue);
    std::swap(*this, *tmp);
    delete tmp;
    return *this;
}
template <typename Data>
lasd::QueueLst<Data>& lasd::QueueLst<Data>::operator=(QueueLst&& yQueue) noexcept{
    std::swap(size, yQueue.size);
    std::swap(head, yQueue.head);
    return *this;
}
